...
async function client(f, device = 'phone') {
  ...
  const c = vm.createContext({
    ...
    offlineReady: true, storagePersistent: true, inlineTextContext: null, TextEncoder, seal, unseal, validateBundle, merge, $, dateText: value => value || '尚未同步', renderHealthAudit: () => {},
  });
